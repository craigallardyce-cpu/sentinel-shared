...
exports.UPDATE_FEED_BASE = void 0;
exports.updateFeedUrl = updateFeedUrl;
exports.compareVersions = compareVersions;
exports.checkLatestRelease = checkLatestRelease;
exports.appVersionHandler = appVersionHandler;
/** Where the website serves the feed. Each app's electron-builder `publish.url` points under it too. */
exports.UPDATE_FEED_BASE = 'https://marinersentinel.com/updates';
const DEFAULT_TIMEOUT_MS = 5000;
const UNREACHABLE = 'Could not reach the update server.';
/** The feed directory for one app, with a trailing slash: `${base}/${app}/`. */
function updateFeedUrl(app, base = exports.UPDATE_FEED_BASE) {
 ...
 */
function appVersionHandler(opts) {
