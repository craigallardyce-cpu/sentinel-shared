...
export function isWithinSector(bearing, center, width) {
 ...
 */
export function calculateAnchorPosition(startLat, startLon, bearingDeg, distanceFeet) {
 ...
 */
export function getGeometryDistance(geometry, lat, lon) {
...
export function getMaxScaleDenominator(zoom) {
    if (zoom >= 16)
        return 25000;
    if (zoom >= 13)
        return 80000;
...
export function getTargetScaleRange(zoom) {
    if (zoom >= 16)
...
export function hasPassedWaypoint(prevLat, prevLon, currentLat, currentLon, vesselLat, vesselLon) {
...
export function calculateXTE(startLat, startLon, endLat, endLon, currentLat, currentLon) {
...
export function generateRmbSentence(status = 'A', xte = 0, steerDir = 'L', originWp = 'WP0', destWp = 'WP1', destLat = 0, destLon = 0, range = 0, bearing = 0, velocity = 0, arrivalStatus = 'V') {
