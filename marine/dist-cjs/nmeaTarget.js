...
exports.DEFAULT_NMEA_TARGET = void 0;
exports.splitPoolKey = splitPoolKey;
exports.resolveNmeaTarget = resolveNmeaTarget;
exports.stalePoolKeys = stalePoolKeys;
/** The gateway most boats ship with, and what both apps defaulted to independently. */
exports.DEFAULT_NMEA_TARGET = { host: '10.10.10.1', port: '11102' };
 ...
 */
function splitPoolKey(key) {
    const at = key.lastIndexOf(':');
    if (at <= 0 || at === key.length - 1)
        return null;
    return { host: key.slice(0, at), port: key.slice(at + 1) };
}
function resolveNmeaTarget(input = {}) {
    const fallback = input.fallback ?? exports.DEFAULT_NMEA_TARGET;
 ...
 */
function stalePoolKeys(activeKeys, current) {
