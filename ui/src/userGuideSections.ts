...
export const USER_GUIDE_APP_SECTION = {
  ...
  oceansentinel: 'ocean',
  vesselkeeper: 'keeper',
} as const satisfies Record<string, UserGuideSection>;
 ...
 */
export function userGuideUrl(section?: UserGuideSection | null): string {
  if (section && (USER_GUIDE_ANCHORS as readonly string[]).includes(section)) {
