 ...
 */
function wholeDaysLeft(daysLeft) {
...
export function PlanPill({ planLabel, trial = false, daysLeft = null, onManage, onConvert }) {
    ...
    const tone = !trial ? 'paid' : days !== null && days <= TRIAL_ENDING_DAYS ? 'trialEnding' : 'trial';
    ...
    return (_jsxs("span", { className: "inline-flex items-center gap-2 min-w-0", children: [_jsx("button", { type: "button", onClick: onManage, title: manageName, "aria-label": manageName, className: cn(
            ...
            _jsx(Button, { variant: "ghost", size: "sm", onClick: onConvert, title: convertName, "aria-label": convertName, className: "shrink-0", children: "Upgrade" }))] }));
}
