 ...
 */
export const Button = React.forwardRef(function Button({ variant = 'secondary', size = 'md', icon, loading = false, block = false, className, children, disabled, type = 'button', ...rest }, ref) {
    return (_jsxs("button", { ref: ref, type: type, disabled: disabled || loading, className: cn('inline-flex items-center justify-center font-medium select-none whitespace-nowrap transition-[background-color,border-color,filter,transform] duration-150', 'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan/60 focus-visible:ring-offset-2 focus-visible:ring-offset-bg-app', 'disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:brightness-100 active:scale-[0.98]', VARIANT[variant], SIZE[size], block && 'w-full', className), ...rest, children: [loading ? _jsx(Loader2, { className: "animate-spin", size: size === 'sm' ? 14 : 16, "aria-hidden": true }) : icon, children] }));
});
