...
export const FLEET_SETTINGS = createRegistry({
  ...
  */
  ...
  'display.density': defineSetting({
    ...
    */
    type: oneOf(['compact', 'comfortable'] as const),
    label: 'Row density',
  ...
  */
  ...
  'logbook.included_nmea': defineSetting({
    ...
    */
    type: listType(oneOf(['position', 'cogSog', 'wind', 'depth', 'temp', 'battery'] as const)),
  ...
  'logbook.quick_tap_presets': defineSetting({
    ...
    */
    type: listType(
      shapeType<{ id: string; label: string; text: string }>('preset', {
  ...
  */
  ...
  'chart.orientation': defineSetting({
    scopes: ['device'],
    type: oneOf(['north-up', 'heading-up'] as const),
    default: 'north-up',
  ...
  'position.entered_fix': defineSetting({
    ...
    */
    scopes: ['device'],
    type: shapeType<{ lat: number; lon: number }>('fix', {
