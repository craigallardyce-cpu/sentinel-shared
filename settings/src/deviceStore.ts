...
import type { AnyDefinition, Registry, AnySpec } from './registry.js';
...
export function createDeviceStore(storage: StorageLike, options: DeviceStoreOptions): DeviceStore {
