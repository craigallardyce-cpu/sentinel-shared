 ...
 */
export const boolType = make('bool', (raw) => {
...
export function intType(options = {}) {
 ...
 * assumption.
 */
export const hostType = make('host', (raw) => {
    const value = text(raw);
    if (value === null)
        return undefined;
...
export const portType = make('port', (raw) => intType({ min: 1, max: 65535 }).parse(raw), (value) => String(value));
/**
 ...
 */
export function urlType(options = {}) {
 ...
 * number is not.
 */
export const mmsiType = make('mmsi', (raw) => {
    const value = text(raw);
    if (value === null)
        return undefined;
 ...
 */
export function shapeType(name, fields) {
