...
exports.isInsideNwsCoverage = isInsideNwsCoverage;
exports.formatPosition = formatPosition;
exports.getOpenMeteoForecast = getOpenMeteoForecast;
exports.clearForecastCache = clearForecastCache;
...
function isInsideNwsCoverage(lat, lon) {
 ...
 */
async function getOpenMeteoForecast(lat, lon, options = {}) {
