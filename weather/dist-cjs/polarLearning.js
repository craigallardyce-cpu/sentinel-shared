...
exports.createPolarAccumulator = createPolarAccumulator;
exports.trueWindAngle = trueWindAngle;
exports.addSample = addSample;
exports.mergeAccumulators = mergeAccumulators;
exports.derivePolar = derivePolar;
exports.toPolFile = toPolFile;
exports.serializeAccumulator = serializeAccumulator;
exports.deserializeAccumulator = deserializeAccumulator;
...
function createPolarAccumulator(twaValues = DEFAULT_TWA, twsValues = DEFAULT_TWS) {
    return {
        version: 1,
        twaValues: [...twaValues],
        twsValues: [...twsValues],
...
function trueWindAngle(twdDeg, headingDeg) {
    return (0, polars_js_1.foldTwa)(headingDeg - twdDeg);
}
 ...
 */
function addSample(accumulator, sample, options = {}) {
...
function mergeAccumulators(a, b) {
 ...
 */
function derivePolar(accumulator, options = {}) {
    const { fallback = polars_js_1.GENERIC_POLARS.cruisingMonohull, percentile = 0.9, minSamples = 30, name } = options;
    ...
    for (let i = 0; i < twaValues.length; i++) {
        ...
        for (let j = 0; j < twsValues.length; j++) {
            ...
            const generic = (0, polars_js_1.boatSpeed)(fallback, twa, tws);
...
function deserializeAccumulator(text) {
