...
export function foldTwa(twaDeg) {
 ...
 */
export function bestVmg(polar, twsKts, direction) {
 ...
 */
export function parsePolarFile(text, name = 'Imported polar') {
    const rows = text
        .split(/\r?\n/)
        .map((line) => line.trim())
