...
export function boundsForPassage(start, destination, marginDeg = 2) {
    return {
...
export function toComponents(speedKts, directionFromDeg) {
...
export function fromComponents(u, v) {
 ...
 */
export function createWindSampler(field) {
