...
export function isUsablePowerProfile(profile) {
    if (!profile)
        return false;
 ...
 */
export function windageLossFraction(profile, twaDeg, twsKts) {
 ...
 */
export function powerPolar(profile) {
    const speed = positive(profile.economicSpeedKts);
    if (!speed) {
 ...
 * does.
 */
export function powerSeaState(profile) {
    return {
 ...
 */
export function powerRangeFrom(profile) {
