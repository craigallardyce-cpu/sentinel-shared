 ...
 */
export function waveToComponents(directionFromDeg) {
...
export function waveFromComponents(u, v) {
 ...
 * positive.
 */
export function currentToComponents(speedKts, setDeg) {
...
export function currentFromComponents(u, v) {
    return {
 ...
 */
export function speedToKnots(value, unit) {
 ...
 */
export async function fetchMarineField(bounds, options = {}) {
 ...
 * running outside it.
 */
export function createWaveSampler(field) {
 ...
 */
export function createCurrentSampler(field) {
    return (lat, lon, timeMs) => {
        const y = slot(field.lats, lat);
        const x = slot(field.lons, lon);
        const t = slot(field.times, timeMs);
