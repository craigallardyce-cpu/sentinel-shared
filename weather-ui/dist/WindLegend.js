...
export default function WindLegend({ isLightBg }) {
    return (_jsxs("div", { className: "glass-panel rounded-lg px-2.5 py-1.5 flex items-center gap-2 select-none pointer-events-none", children: [_jsx("span", { className: "text-[12px] font-mono uppercase tracking-widest text-text-muted", children: "Wind" }), _jsx("div", { className: "flex items-end gap-px", children: WIND_BANDS.map((band) => (_jsxs("div", { className: "flex flex-col items-center gap-1", children: [_jsx("span", { className: "block w-6 sm:w-7 h-1.5 rounded-[1px]", style: { backgroundColor: `rgb(${isLightBg ? band.light : band.dark})` } }), _jsx("span", { className: "text-[12px] font-mono text-text-muted leading-none", children: band.from })] }, band.from))) }), _jsx("span", { className: "text-[12px] font-mono uppercase tracking-widest text-text-muted", children: "Kts" })] }));
}
